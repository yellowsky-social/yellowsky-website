...
export default function Splash() {
  ...
  return (
    <div className='relative place-items-center m-auto max-w-screen min-h-fit lg:pt-2 p-1 md:pl-4 sm:pr-4'>
      <div className='max-w-prose w-fit mx-auto'>
        <Image
          className='relative mx-auto dark:drop-shadow-[0_0_0.3rem_#ffffff70 w-full sm:mt-16 lg:mt-8'
          src='/ysky.png'
          alt='ysky Logo'
          width={300}
          height={100}
