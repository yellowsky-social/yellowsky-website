...
export default function Content() {
    ...
    return (
        <div className="static place-items-center mx-auto max-w-screen h-screen pt-12 lg:pt-2 p-1 md:pl-4 sm:pr-4">
            <div className="max-w-prose w-fit mx-auto">
                <Image
                    className="relative mx-auto dark:drop-shadow-[0_0_0.3rem_#ffffff70 w-full sm:mt-32 lg:mt-12"
                    src="/ysky.png"
                    alt="ysky Logo"
                    width={300}
                    height={100}
