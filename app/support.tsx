...
import {BsBalloonHeartFill, MdOutlineAlternateEmail} from "react-icons/all";
                                ...
                                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-black p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-6">
                                        <p className="text-sm text-yellow-400 font-semibold font-mono">
                                            ...
                                            <br />
                                            <br />
                                            I plan to build some smaller projects using the Bluesky app to get some experience with AT Proto while planning an own platform.
