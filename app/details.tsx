    ...
    return (
        <div
            ...
            <div className="flex font-black lg:text-8xl text-6xl w-fit mx-auto">
                <h1 className="flex bg-black p-5 pt-3 text-yellow-400 text-center border-8 border-yellow-400 hover:border-yellow-400 hover:text-black hover:bg-yellow-400">
                    yellow is the future</h1>
            </div>
